                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        ...
                        <div class="layui-card-header">
                            <button class="layui-btn" onclick="x_admin_show('添加用户','./adduser',600,400)"><i class="layui-icon"></i>添加用户</button>
                        	<button class="layui-btn layui-btn-warm" onclick="x_admin_show('添加用户','./admin-add.html',600,400)"> <i class="layui-icon">&#xe673;</i>权限管理</button>
                        	<button class="layui-btn layui-btn-danger" onclick="delAll()"><i class="layui-icon"></i>删除用户</button>
                        </div>
                        <div class="layui-card-body ">
                            <table class="layui-table layui-form">
                              ...
                              <tbody>
                              <c:forEach items="${sessionScope.userselect }" var="user">
	                              <tr>
	                                  <td>
	                                    <input type="checkbox" name=""  lay-skin="primary">
	                                  </td>
