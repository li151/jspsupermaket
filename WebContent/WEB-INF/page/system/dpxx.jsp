                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        ...
                        <div class="layui-card-header">
                            ...
                            <button class="layui-btn" onclick="x_admin_show('添加店铺','./admin-add.html',600,400)"><i class="layui-icon"></i>添加店铺</button>
                        	<button class="layui-btn layui-btn-danger" onclick="delAll()"><i class="layui-icon"></i>删除店铺</button>
                        </div>
