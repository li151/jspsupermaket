                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        ...
                        <div class="layui-card-header">
                            ...
                            <button class="layui-btn" onclick="x_admin_show('添加部门','./admin-add.html',600,400)"><i class="layui-icon"></i>添加部门</button>
                       		<button class="layui-btn layui-btn-danger" onclick="delAll()"><i class="layui-icon"></i>删除部门</button>
                        </div>
