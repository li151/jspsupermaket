                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        ...
                        <div class="layui-card-header">
                            ...
                            <button class="layui-btn" onclick="x_admin_show('添加用户','./admin-add.html',600,400)"><i class="layui-icon"></i>新增供应商联系人</button>
                       		 <button class="layui-btn layui-btn-warm" onclick="delAll()"><i class="layui-icon"></i>修改供应商联系人</button>
                       		  <button class="layui-btn layui-btn-danger" onclick="delAll()"><i class="layui-icon"></i>删除供应商联系人</button>
                        </div>
