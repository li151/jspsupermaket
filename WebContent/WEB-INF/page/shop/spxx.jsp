                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        ...
                        <div class="layui-card-header">
                            ...
                            <button class="layui-btn" onclick="x_admin_show('添加用户','./admin-add.html',600,400)"><i class="layui-icon"></i>添加商品信息</button>
                       		<button class="layui-btn layui-btn-warm" onclick="delAll()"><i class="layui-icon"></i>修改商品信息</button>
                       		<button class="layui-btn layui-btn-danger" onclick="delAll()"><i class="layui-icon"></i>删除商品信息</button>
                        </div>
